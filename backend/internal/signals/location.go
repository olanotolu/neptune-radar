...
var cityPatterns = []struct {
	...
	{regexp.MustCompile(`(?i)\bsan\s*francisco\b`), "San Francisco", "CA"},
	{regexp.MustCompile(`(?i)\bbay\s*area\b`), "San Francisco", "CA"},
	{regexp.MustCompile(`(?i)\bmalibu\b`), "Malibu", "CA"},
	{regexp.MustCompile(`(?i)\bbeverly\s*hills\b`), "Beverly Hills", "CA"},
	{regexp.MustCompile(`(?i)\bsanta\s*monica\b`), "Santa Monica", "CA"},
	{regexp.MustCompile(`(?i)\bnapa\b`), "Napa", "CA"},
	{regexp.MustCompile(`(?i)\bdumbo\b`), "Brooklyn", "NY"},
	{regexp.MustCompile(`(?i)\bwilliamsburg\b`), "Brooklyn", "NY"},
